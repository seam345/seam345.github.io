...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        var temp = this;
        this.http.get('https://seam345.github.io./markdown_files/test.md', { responseType: 'text' })
            .toPromise().then(function (data) {
            console.log(data.valueOf());
            console.log(data.toString());
            _this.markdown = data.toString();
            console.log(_this.markdown);
            console.log(temp.markdown);
            temp.markdown = data;
        });
    }
...
function markedOptions() {
    var renderer = new ngx_markdown__WEBPACK_IMPORTED_MODULE_5__["MarkedRenderer"]();
